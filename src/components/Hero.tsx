    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 pt-32 relative z-10">
        <div className="text-center space-y-8 animate-fade-in">
          ...
          >
            ...
            <br />
            <span className="text-gradient">Who Builds Platforms That Scale</span>
          </h1>
          ...
          >
            I design intelligent, blockchain-secure, and AI-powered apps using ChatGPT, Claude, and
            DeepSeek.
          </p>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <div className={`w-6 h-10 border-2 rounded-full flex justify-center ${
          ...
          <div className={`w-1.5 h-3 mt-2 rounded-full ${
