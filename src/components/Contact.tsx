  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'sumeet@example.com',
      link: 'mailto:sumeet@example.com',
    },
    {
      icon: MapPin,
      label: 'Location',
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-8">
            <div>
              ...
              >
                Whether you need a full-stack web application, AI integration, Web3 solution, or
                cloud infrastructure, I'm here to help bring your vision to life.
              </p>
